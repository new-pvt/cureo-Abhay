...
// className={'font-f2 font-w2 leading-[19.56px] md:leading-[24.44px] text-[1rem] md:text-[1.25rem] text-c15'}
        ...
        <main className="space-y-2 p-4">
            ...
            <p className="font-f2 font-w1 md:text-[1rem]  text-c12 leading-[24px] md:px-[22px]">
                ...
                <a
                    ...
                    href="https://cureo.co.in/"
                    target="_blank"
                >
                    www.Cureo.co.in
                </a>
                web site, (the "Web Site"), you are agreeing to be legally bound
                by these Terms & Conditions. The terms "you" and "User" refer to
            ...
            <p className="font-f2 font-w1 md:text-[1rem]  text-c12 leading-[24px] md:px-[22px]">
                ...
                If there is a conflict between these Terms & Conditions and the
                other terms and conditions, the other terms & conditions will
            ...
            <p className="font-f2 font-w1 md:text-[1rem]  text-c12 leading-[24px] md:px-[22px]">
                ...
                agreement to the modified Terms & Conditions and all of the
                changes. Therefore, you should read these Terms & Conditions
            ...
            <p className="font-f2 font-w1 md:text-[1rem]  text-c12 leading-[24px] md:px-[22px]">
                The Web Site and the content, including, but not limited to,
                text, data, reports, opinions, images, photos, graphics, graphs,
                charts, animations and video (the "Content"), displayed on the
                Web Site, may be used only for your personal and non-commercial
                use. Except as otherwise permitted under these Terms &
                Conditions, you agree not to copy, reproduce, modify, create
                derivative works from, or store any Content, in whole or in
            ...
            <p className="font-f2 font-w1 md:text-[1rem]  text-c12 leading-[24px] md:px-[22px]">
                ...
                Site and within the Content are proprietary to their respective
            ...
            <p className="font-f2 font-w1 md:text-[1rem]  text-c12 leading-[24px] md:px-[22px]">
                ...
                and password and provide the website with accurate, complete,
                and updated information. Failure to do so constitutes a breach
                of this Agreement, which may result in immediate termination of
                your access.
            </p>
            <h5
                className={
            ...
            <p className="font-f2 font-w1 md:text-[1rem]  text-c12 leading-[24px] md:px-[22px]">
                ...
                connection with your browsing and use of the Web Site. If you
                are dissatisfied with the Content or the Web Site or with these
                Terms of Use, your sole and exclusive remedy is to stop using
                the Content and the Web Site. The website  will not pay you any
            ...
            <p className="font-f2 font-w1 md:text-[1rem]  text-c12 leading-[24px] md:px-[22px]">
                ...
                OWN CONTENT, THE OTHER CONTENT, NOR ANY MATERIAL THAT CAN BE
                ACCESSED (VIA A DIRECT OR INDIRECT HYPERLINK OR OTHERWISE)
                ...
                NOT SUCH DAMAGES ARE FORESEEN OR UNFORESEEN WITH RESPECT TO ANY
                USE OF THE WEB SITE. NEITHER THE WEBSITE NOR ANY OF ITS
                AFFILIATES, AGENTS OR LICENSORS WILL BE LIABLE TO YOU OR ANYONE
                ELSE FOR ANY LOSS OR INJURY RESULTING FROM USE OF THE WEB SITE,
                IN WHOLE OR PART, WHETHER CAUSED BY NEGLIGENCE, CONTINGENCIES
                BEYOND ITS CONTROL IN PROCURING, COMPILING, INTERPRETING,
                REPORTING OR DELIVERING THE WEB SITE AND ANY CONTENT AT THE WEB
                SITE OR OTHERWISE. IN NO EVENT WILL THE WEBSITE,  ITS
                ...
                CONTENT OR THE WEB SITE.
            </p>
            <p className="font-f2 font-w1 md:text-[1rem]  text-c12 leading-[24px] md:px-[22px]">
                The website assumes no responsibility for the use of third party
                software on the website and shall have no liability whatsoever
                to any person or entity for the accuracy or completeness of any
            ...
            <p className="font-f2 font-w1 md:text-[1rem]  text-c12 leading-[24px] md:px-[22px]">
                You may, through hypertext or other computer links, gain access
                to web sites operated by persons other than the website Such
                hyperlinks are provided for your reference and convenience only,
                and are the exclusive responsibility of such web sites' owners.
                You agree that the website is not responsible for the content or
                operation of such web sites, and that the website shall have no
                liability to you or any other person or entity for the use of
                third party web sites. Except as described below, a hyperlink
                from this Web Site to another web site does not imply or mean
                that the website endorses the content on that web site or the
                operator or operations of that site. You are solely responsible
                for determining the extent to which you may use any content at
                any other web sites to which you link from the Web Site.
            </p>
            <h5
                className={
                    "font-f2 font-w2 leading-[19.56px] md:leading-[24.44px] text-[1rem] md:text-[1.25rem] text-c15"
            ...
            <p className="font-f2 font-w1 md:text-[1rem]  text-c12 leading-[24px] md:px-[22px]">
                ...
                or indirect hyperlinks from the Web Site. However, the website
                retains the right, which it may or may not exercise in its sole
                discretion ,to review, edit, or delete Other Content that the
                website deems to be illegal, offensive, or otherwise
                inappropriate.
            </p>
            <p className="font-f2 font-w1 md:text-[1rem]  text-c12 leading-[24px] md:px-[22px]">
                You may not input or distribute any material through the Web
                Site that is promotional in nature, including solicitations for
                funds or business, without the prior written authorization of
                the website.
            </p>
            <p className="font-f2 font-w1 md:text-[1rem]  text-c12 leading-[24px] md:px-[22px]">
            ...
            <p className="font-f2 font-w1 md:text-[1rem]  text-c12 leading-[24px] md:px-[22px]">
                All information, reports, content and access rights purchased on
                the website are non refundable.
            </p>
            <p className="font-f2 font-w1 md:text-[1rem]  text-c12 leading-[24px] md:px-[22px]">
            ...
            <p className="font-f2 font-w1 md:text-[1rem]  text-c12 leading-[24px] md:px-[22px]">
                This Agreement will continue until terminated by either the or
                you. Either party can terminate the Agreement by notifying the
                other party by telephone or electronic mail of the decision to
                terminate.
            </p>
            <p className="font-f2 font-w1 md:text-[1rem]  text-c12 leading-[24px] md:px-[22px]">
                ...
                writing, with respect to the Web Site. The failure of the
                ...
                Agreement is personal to you, and you may not assign your rights
                or obligations to anyone. If any provision in this Agreement is
                ...
                India and subject to jurisdiction of courts of Bangalore, as if
                the Agreement was a contract wholly entered into and wholly
                performed within Bangalore, and any litigation related to this
                Agreement shall be brought exclusively in the courts of
                Bangalore. All rights not expressly granted herein are reserved.
            </p>
            <h5
                className={
                    "font-f2 font-w2 leading-[19.56px] md:leading-[24.44px] text-[1rem] md:text-[1.25rem] text-c15"
            ...
            <p className="font-f2 font-w1 md:text-[1rem]  text-c12 leading-[24px] md:px-[22px]">
                You expressly agree not to use this Web Site in any manner or
                for any purpose that is prohibited by these terms and
                conditions. In addition, you expressly agree not to: (1) use the
                Web Site for any purpose that is prohibited by any law or
                regulation, or to facilitate the violation of any law or
                regulation;
            </p>
            <p className="font-f2 font-w1 md:text-[1rem]  text-c12 leading-[24px] md:px-[22px]">
                (2) use or attempt to use any "deep-link," "scraper," "robot,"
                "bot," "spider," "data mining," "computer code" or any other
                automated device, program, tool, algorithm, proc-ess or
                methodology or manual process having similar processes or
                functionality, to access, ac-quire, copy, or monitor any portion
                of the Web Site or any data or content found on or accessed
                through the Web Site without prior express written consent;
            </p>
            <p className="font-f2 font-w1 md:text-[1rem]  text-c12 leading-[24px] md:px-[22px]">
                (3) obtain or attempt to obtain through any means any materials
                or information on the Web Site that have not been intentionally
                made publicly available either by their public display on the
                Web Site or through their accessibility by a visible link on the
                Web Site;
            </p>
            <p className="font-f2 font-w1 md:text-[1rem]  text-c12 leading-[24px] md:px-[22px]">
                (4) in any way bypass or circumvent any other measure employed
                to limit or pre-vent access to the Web Site or its content;
            </p>
            <p className="font-f2 font-w1 md:text-[1rem]  text-c12 leading-[24px] md:px-[22px]">
                (5) violate the security of the Web Site or attempt to gain
                unauthorized access to the Web Site, data, materials,
                information, computer systems or networks connected to any
                server associated with this Web Site, through hacking, password
                mining or any other means;
            </p>
            <p className="font-f2 font-w1 md:text-[1rem]  text-c12 leading-[24px] md:px-[22px]">
                (6) interfere or attempt to interfere with the proper working of
                the Web Site or any activities conducted on or through the Web
                Site, including accessing any data, content or other information
                prior to the time that it is intended to be available to the
                public on the Web Site;
            </p>
            <p className="font-f2 font-w1 md:text-[1rem]  text-c12 leading-[24px] md:px-[22px]">
                (7) take or attempt any action that, in the sole discretion of
                this Web Site's operators, imposes or may impose an unreasonable
                or disproportionately large load or burden on the Web Site or
                such operation's infrastructure.
            </p>
        </main>
    );
};
