...
const ShowSlots = ({ data, getScheduleData }) => {
    const { doctor, appointmentBy } = useContext(AppointmentSettingContext);
    const [editSlot, setEditSlot] = useState();

    if (editSlot) return <EditSlots data={data} getScheduleData={getScheduleData}/>;
